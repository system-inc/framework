...
// Class
class InputSelectEventElectronTest extends HtmlElectronTest {
	...
	async testInputSelectEvent() {
        ...
        var textAreaElement = Html.textarea('FrameworkInputSelectEventElectronTest');
		...
		Assert.strictEqual(capturedEventInputSelect.text, 'FrameworkInputSelectEventElectronTest', 'text property is set correctly');
...
// Export
export { InputSelectEventElectronTest };
