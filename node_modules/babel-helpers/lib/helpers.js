...
helpers.clonePrototypeProperties = /*istanbul ignore next*/(0, _babelTemplate2.default)( /*istanbul ignore next*/`
	(function(context, classDefinition) {
		...
		function clone(value) {
	        ...
	        //    valueClone = Object.create(value);
	        //    for(var key in value) {
	        //        valueClone[key] = clone(value[key]);
	        //    }
	        //}
	        // If we have an array or object
	        else if(value && typeof(value) === 'object') {
	            // Start out with a simple array or object
	            valueClone = Object.prototype.toString.call(value) === '[object Array]' ? [] : {};

	            // Call clone for each item in the array or object
	            for(var key in value) {
		...
		//console.log(Object.keys(classDefinition.prototype));
		Object.keys(classDefinition.prototype).forEach(function(key) {
			//console.log('Cloning', key, classDefinition.prototype[key]);
			context[key] = clone(classDefinition.prototype[key]);
		});
	});
`);
