      ...
      Class: function Class(path) {
        ...
        for (var _iterator2 = props, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : (0, _getIterator3.default)(_iterator2);;) {
          ...
          if (isStatic) {
            ...
            // Define member properties on the prototype outside of the constructor
            ...
            var propNodeKeyClone = propNode.key.__clone();
            propNodeKeyClone.name = 'prototype.'+propNodeKeyClone.name;
            nodes.push(t.expressionStatement(t.assignmentExpression("=", t.memberExpression(ref, propNodeKeyClone), propNode.value)));
          }
        }
